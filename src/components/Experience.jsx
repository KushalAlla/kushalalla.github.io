...
//         >
//             <div className="max-w-screen-lg w-full px-4 flex flex-col md:flex-row items-start justify-between gap-12">
...
//                                 Software Engineer — E-Learning Company
//                             </h3>
//                             <p>Jan 2022 – Aug 2023</p>
//                             <ul className="list-disc list-inside mt-2">
//                                 <li>Designed and developed scalable full-stack web applications using ReactJS, NodeJS, ASP.NET, and SQL within a 3-layer
//                                     architecture, contributing to platform stability as part of an 8-member team.</li>
//                                 <li>Created reusable React components for client-side modules, streamlining frontend efficiency by 20% and standardizing UI
//                                     components to reduce code redundancy.</li>
//                                 <li>Deployed applications via IIS and optimized server configurations, resulting in 15% faster load times and seamless environment
//                                     transitions.</li>
//                                 <li>Automated a few manual tasks with Windows Services, ASP.NET framework, and APIs, utilizing log files for cross-
//                                     verification, reducing manual labor by 6 hours weekly and enhancing operational efficiency by 15%.</li>
//                                 <li>Maintained codebase using TFS for version control, ensuring team collaboration and reducing integration conflicts across
...
//                                 <li>Partnered with cross-functional teams to deliver 10+ features on time, ensuring code quality via peer reviews and performance
//                                     benchmarks.</li>
//                             </ul>
//                         </motion.div>
...
//                         >
//                             <h3 className="text-xl font-semibold text-white">
//                                 Software Dev Intern — [Company Name]
//                             </h3>
//                             <p>Jan 2020 – Jun 2020</p>
//                             <ul className="list-disc list-inside mt-2">
//                                 <li>Developed frontend and backend modules using HTML, CSS, JS, Python, and MySQL, delivering 2 new features and
//                                     improving platform functionality by 25%.</li>
...
//                                 <li>Managed version control using Git and GitHub, enabling effective code reviews and streamlined collaboration with 3
//                                     developers.</li>
//                                 <li>Participated in code reviews and pair programming with senior developers, accelerating skill development in Python and
