        ...
        >
            <div className="max-w-screen-lg w-full px-4 flex flex-col md:flex-row items-center md:items-start justify-between gap-12">
                ...
                <div className="flex-1 text-left">
                    ...
                    >
                        Full-stack Developer and master's graduate experienced in building scalable applications
                        with ReactJS, ASP.NET, and NodeJS. Enhanced frontend efficiency by 20% and improved load
                        times, fixed routing bugs through optimized server configurations. Aiming to leverage
                        skills in agile development to deliver innovative solutions as a Full Stack Engineer.
                    </motion.p>
                </div>
